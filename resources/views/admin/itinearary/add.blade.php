<x-app-layout>
    ...
    <form action="{{ route('itinearary.store') }}" class="w-full pb-[100px] " method="post">
        @csrf
        <div class="w-full px-[200px] pb-[20px]">
            ...
            <a href="{{ route('itinearary.list') }}" class=" float-left bg-blue-600 px-[15px] py-[6px] text-white rounded-md">List</a>
        </div>
        ...
        <div id="itinerary" class="border-[2px] py-[50px]">
            <div class="itinerary-box w-full h-auto flex flex-col justify-center items-center gap-y-5 ">
                <div class="w-1/2">
                    ...
                    <input type="text" class="w-full " name="itinerary[0][day]">
                </div>
                <div class="w-1/2">
                    <label class="text-[20px] font-semibold p-[5px]">Title</label>
                    <input type="text" class="w-full " name="itinerary[0][title]">
                </div>
                <div class="w-1/2">
                    <label class="text-[20px] font-semibold p-[5px]">Description</label>
                    <textarea name="itinerary[0][description]" id="description-0" cols="30" rows="10" class="w-full"></textarea>
                </div>
