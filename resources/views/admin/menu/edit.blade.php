<x-app-layout>
    ...
    <form action="{{ route('menu.update',$menu->id) }}" class="w-full pb-[100px] " method="post">
        @csrf
        ...
        <div class="w-full h-auto flex flex-col justify-center items-center gap-y-5 pb-[50px]">
            <div class="w-1/2">
                ...
                <input type="text" class="w-full rounded-md " name="name" value="{{ $menu->name }}">
            </div>
            ...
            <div class="w-1/2">
                ...
                <input type="text" class="w-full rounded-md " name="url" value="{{ $menu->url }}">
            </div>
        </div>
    </form>
</x-app-layout>
